...
vec4 fractalColor(vec2 uv) {
    ...
    // Combine texture textTextureles with color modulation
    vec4 col1 = texture(textTexture, uv1);
    vec4 col2 = texture(textTexture, uv2);
    vec4 col3 = texture(textTexture, uv3);
