...
void main(void) {
    ...
    vec4 color1 = texture(textTexture, tc);
    vec4 color2 = texture(textTexture, tc - offset);
    vec4 color3 = texture(textTexture, tc - offset * 2.0);
    vec4 color4 = texture(textTexture, tc - offset * 3.0);
