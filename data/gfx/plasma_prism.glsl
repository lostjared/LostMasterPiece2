...
void main() {
    ...
    vec3 prismColor;
    prismColor.r = texture(textTexture, tc + vec2(dispersion, 0.0)).r;
    prismColor.g = texture(textTexture, tc).g;
    prismColor.b = texture(textTexture, tc - vec2(dispersion, 0.0)).b;
