...
void main(void)
{
    ...
    vec4 color2 = texture(textTexture, tc/value1);
    vec4 color3 = texture(mat_textTexture, tc/value2);
    vec4 color4 = texture(textTexture, tc/value3);
    vec4 color5 = texture(mat_textTexture, tc/value4);
