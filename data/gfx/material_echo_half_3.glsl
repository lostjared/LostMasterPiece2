...
void main(void)
{
    ...
    vec4 color2 = (0.5 * texture(textTexture, tc1/2)) + (0.5 * texture(mat_textTexture, tc1/2));
    vec4 color3 = (0.5 * texture(textTexture, tc/4)) + (0.5 * texture(mat_textTexture, tc/4));
    vec4 color4 = (0.5 * texture(textTexture, tc2/6)) + (0.5 * texture(mat_textTexture, tc2/6));
