...
void main(void) {
    ...
    vec4 color1 = texture(textTexture, distortedTC + vec2(glitchIntensity * 0.02, 0.0));
    vec4 color2 = texture(textTexture, distortedTC - vec2(glitchIntensity * 0.02, 0.0));
    ...
    color.r = texture(textTexture, distortedTC + chromaOffset).r;
    color.b = texture(textTexture, distortedTC - chromaOffset).b;
