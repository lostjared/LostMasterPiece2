...
void main(void) {
    ...
    vec4 texR = texture(textTexture, uv  + vec2(chromaIntensity, -chromaIntensity));
    vec4 texG = texture(textTexture, uv + vec2(-chromaIntensity, 0.0));
    vec4 texB = texture(textTexture, uv + vec2(0.0, chromaIntensity));
