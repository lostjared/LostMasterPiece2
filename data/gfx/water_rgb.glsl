...
void main(void) {
    ...
    // textTexturele channels with combined effects
    vec4 originalColor = texture(textTexture, tc);
    originalColor.r = texture(textTexture, finalTC_R).r;
    originalColor.g = texture(textTexture, finalTC_G).g;
    originalColor.b = texture(textTexture, finalTC_B).b;
