...
void main(void) {
    ...
    vec4 texColor = texture(textTexture, pos);
    vec4 shiftedColor1 = texture(textTexture, pos + vec2(value_alpha_b * 0.01, 0.0));
    vec4 shiftedColor2 = texture(textTexture, pos + vec2(0.0, value_alpha_b * 0.01));
