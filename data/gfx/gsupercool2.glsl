...
void main(void) {
    ...
    vec4 color_textTexturele = texture(textTexture, uv_zoom);

    vec3 color_effect;
    color_effect.r = sin(color_textTexturele.r * 10.0 + time_f);
    color_effect.g = sin(color_textTexturele.g * 10.0 + time_f + 2.0);
    color_effect.b = sin(color_textTexturele.b * 10.0 + time_f + 4.0);

    color = vec4(color_effect, color_textTexturele.a);
    color.a = 1.0;
}
