...
void main(void) {
    ...
    vec4 redChannel = texture(textTexture, tc + redOffset);
    vec4 greenChannel = texture(textTexture, tc + greenOffset);
    vec4 blueChannel = texture(textTexture, tc + blueOffset);
