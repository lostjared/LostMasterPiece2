...
void main(void) {
    ...
    vec4 colorLeft = texture(textTexture, tc + vec2(-1.0 / iResolution.x, 0.0));
    vec4 colorRight = texture(textTexture, tc + vec2(1.0 / iResolution.x, 0.0));
    vec4 colorUp = texture(textTexture, tc + vec2(0.0, 1.0 / iResolution.y));
    vec4 colorDown = texture(textTexture, tc + vec2(0.0, -1.0 / iResolution.y));
