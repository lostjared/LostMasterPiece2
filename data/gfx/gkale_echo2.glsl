...
vec4 firstEffect(vec2 tc) {
    ...
    vec4 color1 = texture(textTexture, tc1);
    vec4 color2 = texture(textTexture, tc2);
    vec4 color3 = texture(textTexture, tc3);
    vec4 color4 = texture(textTexture, tc4);
...
void main(void) {
    ...
    vec4 tcolor = blur(textTexture, uv, iResolution);
