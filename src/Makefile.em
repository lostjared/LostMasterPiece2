CXX = em++
CXXFLAGS = -std=c++20 -O2 -DFOR_WASM -s USE_SDL=2 -s USE_SDL_TTF=2 -s NO_DISABLE_EXCEPTION_CATCHING
...
MX_INCLUDE = -I$(LIBS_PATH)/mx2/include -I/usr/include/glm -I./include
...
SOURCES = main.cpp gameover.cpp intro.cpp quadtris.cpp shader_library.cpp start.cpp
OBJECTS = $(SOURCES:.cpp=.o)
OUTPUT = LostMasterPiece2.html
